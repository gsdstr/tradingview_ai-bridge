...
export async function setInputs(options: { entity_id: string; inputs: any }): Promise<any> {
...
export async function toggleVisibility(options: { entity_id: string; visible: boolean }): Promise<any> {
